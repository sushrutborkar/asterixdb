...
public class SwitchOperatorDescriptor extends AbstractReplicateOperatorDescriptor {
    ...
    private final HashMap<Integer, int[]> outputMapping;
    ...
    public SwitchOperatorDescriptor(IOperatorDescriptorRegistry spec, RecordDescriptor rDesc, int outputArity,
            ...
            HashMap<Integer, int[]> outputMapping) {
    ...
    private final class SwitcherMaterializerActivityNode extends ReplicatorMaterializerActivityNode {
        private static final long serialVersionUID = 1L;

        public SwitcherMaterializerActivityNode(ActivityId id) {
            super(id);
        }
